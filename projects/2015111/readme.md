...
Οι αναφορές των παραδοτέων που ακολουθούν καταγράφουν τις αλλαγές και προσθήκες με βάση τη χρονολογική σειρά που υλοποιήθηκαν μέχρι το τέλος της προθεσμίας κάθε παραδοτέου. Για την συνολική καταγραφή των αλλαγών που αφορούσαν κάθε παραδοτέο αλλά και έξτρα λειτουργίες που προστέθηκαν, συμβουλευτείτε την τελική αναφορά.
