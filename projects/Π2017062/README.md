...
### 1B
  ...
  Εμφάνισα την ιστοσελίδα μέσω netlify, όπως ανέφεραν οι οδηγίες και όπως είπα προηγουμένως δεν αντιμετώπισα προβλήματα στην εμφάνιση της στήλης με τις αναρτήσεις μου, ωστόσο μόλις προσπαθούσα να ανεβάσω κάποια δική μου ανάρτηση το github με προειδοποιούσε πως υπάρχουν σφάλματα στην ιστοσελίδα. Προσπάθησα επιφυλακτικά να τα διορθώσω μιας και ήταν σε φακέλους που υπήρχαν εξαρχής στην σελίδα και δε δημιούργησα εγώ, χωρίς αποτέλεσμα. Μόλις διόρθωνα ένα σφάλμα εμφάνιζε ειδοποίηση πως υπάρχει κάποιο άλλο μέσα στην σελίδα. Στη προσωπική μου ιστοσελίδα εμφανίζει μόνο το όνομα της δημοσίευσης μου καθώς και μια σύντομη περιγραφή στο search bar αλλά όταν προσπαθώ να μπώ στις αντίστοιχες πληροφορίες λέει πως η σελίδα δε μπορεί να βρεθεί. 
