...
# Ονοματεπώνυμο: Σάκκας Κωνσταντίνος

# ΑΜ: Π2016018

# Επιλογή Εργασίας Περιεχομένου

Link Social Media : https://twitter.com/Konstan79147322

Εκτελέσιμο link ιστοσελίδας: https://kostassakkas.github.io/gr/

Αποθετήριο κώδικα ιστοσελίδας: https://github.com/kostassakkas/gr


# Επιλογή Εργασίας Ανάπτυξης
Shooter (https://github.com/kostassakkas/shooter)

Εκτελέσιμο: https://kostassakkas.github.io/Shooter/

Αποθετήριο κώδικα: https://github.com/kostassakkas/Shooter
